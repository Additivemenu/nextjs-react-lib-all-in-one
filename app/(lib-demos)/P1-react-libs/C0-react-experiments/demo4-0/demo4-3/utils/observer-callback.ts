...
export const observerCallback = (mutations: MutationRecord[]) => {
  ...
  mutations.forEach((mutation) => {
    ...
    // ! DOM change here
    // add websocket or server event trigger status change of the loader and add new task tracker?
    ...
    // // ! case2:  Set up SSE connection  -> TODO: should make this in a context and globally available
